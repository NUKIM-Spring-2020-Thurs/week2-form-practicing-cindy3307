...
<form action="A1073307_submit.php" method="post">
...
<h1>
	...
	<b>年齡:</b><input type="number" name="number"><br/><br/>
	<b>身高:</b><i> 0 cm <input type="range" min="0" max="300"> 300 cm</i><br/><br/>
	<b>體重:</b><i> 0 kg <input type="range" min="0" max="200"> 200 kg</i><br/><br/>
	<b>身分證字號:</b><input type="password" name="password"><br/><br/>
	...
	<b>如何得知資管營的消息:</b><br/>
		<i>粉絲專頁</i><input type="checkbox" name="num1" value="Internet" checked>
		<i>到校宣傳</i><input type="checkbox" name="num2" value="school">
		<i>親友告知</i><input type="checkbox" name="num3" value="friend">
		<i>海報傳單</i><input type="checkbox" name="num1" value="flyer">
		<i>其他</i><input type="checkbox" name="num1" value="other">
